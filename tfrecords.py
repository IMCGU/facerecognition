...
def parse_args():
    ...
    # parser.add_argument('--bin_path', default='C:\\Users\\HanHan\\insightface-master\\datasets\\faces_umd\\train.rec', type=str,
                        # help='path to the binary image file')
    # parser.add_argument('--idx_path', default='C:\\Users\\HanHan\\insightface-master\\datasets\\faces_umd\\train.idx', type=str,
                        # help='path to the image index path')
    parser.add_argument('--bin_path', default='C:\\Users\\HanHan\\insightface-master\\datasets\\p1list\\trainp1.rec', type=str,
                        help='path to the binary image file')
    parser.add_argument('--idx_path', default='C:\\Users\\HanHan\\insightface-master\\datasets\\p1list\\trainp1.idx', type=str,
                        help='path to the image index path')                    
    parser.add_argument('--tfrecords_file_path', default='C:\\Users\\HanHan\\insightface-master\\datasets\\tfrecords', type=str,
